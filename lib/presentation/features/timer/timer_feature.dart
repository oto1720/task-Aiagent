...
import 'package:task_aiagent/presentation/features/timer/widgets/timer_display.dart';
import 'package:task_aiagent/presentation/features/timer/widgets/timer_controls.dart';
import 'package:task_aiagent/presentation/features/timer/widgets/timer_type_selector.dart';
import 'package:task_aiagent/presentation/features/timer/widgets/pomodoro_stats.dart';

/// タイマーフィーチャーメインウィジェット
class TimerFeature extends ConsumerStatefulWidget {
  const TimerFeature({super.key});

  @override
  ConsumerState<TimerFeature> createState() => _TimerFeatureState();
}

class _TimerFeatureState extends ConsumerState<TimerFeature> {
        ...
        child: Column(
          children: [
            ...
            TimerTypeSelector(
              ...
              onTypeSelected: (type) => _handleTypeSelection(context, type),
            ),
  ...
  Future<void> _handleTypeSelection(
    BuildContext context,
    timer_entity.TimerType type,
  ) async {
    setState(() {
      _selectedType = type;
    });
    ...
    if (type == timer_entity.TimerType.custom) {
      ...
      await ref.read(timerProvider.notifier).createTimer(type: type);
    }
  }
